    ...
    public partial class SIDEPSEntities : DbContext
    {
        ...
        public virtual int SP_MOD_REGUSRO(string cEDUSRO07, string nOMUSRO07, string pAPUSRO07, string sAPUSRO07, Nullable<int> cODCANT03, Nullable<int> cODDIAC04, Nullable<int> cODUSRO05, string eSTUSRO07, string dIRUSRO07, string nACUSRO07, string cNTUSRO07, Nullable<System.DateTime> fEIUSRO07, Nullable<System.DateTime> fEFUSRO07, Nullable<System.DateTime> fENUSRO07)
        {
            ...
            var fEIUSRO07Parameter = fEIUSRO07.HasValue ?
                ...
                new ObjectParameter("FEIUSRO07", typeof(System.DateTime));
    
            var fEFUSRO07Parameter = fEFUSRO07.HasValue ?
                new ObjectParameter("FEFUSRO07", fEFUSRO07) :
                new ObjectParameter("FEFUSRO07", typeof(System.DateTime));
        ...
        public virtual int SP_DEL_CATCASO(Nullable<int> cODCASO25, Nullable<int> cODASPS16, string cEDPERS13, Nullable<int> cODVIVI20, Nullable<int> cODEGRF24)
        {
            var cODCASO25Parameter = cODCASO25.HasValue ?
                new ObjectParameter("CODCASO25", cODCASO25) :
                new ObjectParameter("CODCASO25", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_DEL_CATCASO", cODCASO25Parameter, cODASPS16Parameter, cEDPERS13Parameter, cODVIVI20Parameter, cODEGRF24Parameter);
        }
    }
}
